...
```bash [고객 서비스 마인드]
호텔리어는 고객을 최우선으로 생각하고 그들의 편의를 위해 최선을 다해야 합니다. 고객의 요구사항을 신속하고 정확하게 처리하고, 고객이 호텔에 머무는 동안 편안하고 즐거운 시간을 보낼 수 있도록 도와야 합니다.
```

```bash [의사소통 능력]
호텔리어는 고객과 원활하게 의사소통할 수 있어야 합니다. 고객의 질문을 이해하고 그에 대한 답변을 명확하고 간결하게 제시해야 합니다. 또한, 고객의 요구사항을 정확하게 파악하고 그에 맞는 서비스를 제공해야 합니다.
```
...
#default
  ...
  :button-link[Backup]{size="small" icon="IconStackBlitz" href="https://naver.com" blank}
  ::
