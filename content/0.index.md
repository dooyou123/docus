...
#default
  ...
  Back-up Programm
  #description
  백업 프로그램 실행 [Backup](localexplorer:Z:\THE SPLAISIR SEOUL MYEONG-DONG\1. Sotetsu Operations\1. FRONT\10. Staff\Bruce Kang\FD\backupreport.exe) 백업 프로그램 실행 [modules](https://modules.nuxtjs.org) ecosystem.
  ::
  ...
  A,B,C Checklist
  #description
  Edit your theme content and appearance with live-preview within [Checklist](localexplorer:Z:\THE SPLAISIR SEOUL MYEONG-DONG\1. Sotetsu Operations\1. FRONT\2. Shift Check List).
  ::
